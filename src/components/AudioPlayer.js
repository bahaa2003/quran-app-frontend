...
const AudioPlayer = ({ src, recordingId, className = "" }) => {
    ...
    return (
        <div className={`
            backdrop-blur-sm border-2 rounded-2xl p-4 shadow-lg transition-all duration-300
            ${isDarkMode 
        ...
        `}>
            ...
            <div className="flex items-center gap-4">
                ...
                <div className="relative flex-shrink-0">
                    ...
                    {showVolumeSlider && (
                        <div className={`
                            absolute bottom-full mb-2 left-1/2 transform -translate-x-1/2 p-3 rounded-xl shadow-xl border-2 z-10
                            ${isDarkMode 
                                ? 'bg-slate-800 border-slate-700' 
                                : 'bg-white border-slate-200'
                            }
                        `}>
                            <div className="w-20 h-2" dir="ltr">
                                <div 
                                    ref={volumeRef}
                                    className={`
                                ...
                                >
                                    ...
                                    <div 
                                        className={`
                                            absolute top-1/2 transform -translate-y-1/2 w-4 h-4 rounded-full shadow-lg transition-all duration-150
                ...
                <div className="flex-1 mx-3" dir="ltr">
                    <div 
                        ref={progressRef}
                        className={`
                            w-full h-2 rounded-full cursor-pointer transition-all duration-200 relative overflow-hidden
                ...
                <div className="flex gap-2 flex-shrink-0">
                    <button
                        ...
                        className={`
                            w-12 h-12 rounded-full flex items-center justify-center text-white transition-all duration-200 transform hover:scale-105 active:scale-95 shadow-lg
